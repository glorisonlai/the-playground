...
const fragmentShaderSource = require("raw-loader!./../../components/backgrounds/rotation/fragment.glsl");
const vertexShaderSource = require("raw-loader!./../../components/backgrounds/rotation/vertex.glsl");

const blah = (width: number, height: number) => {
...
export default noSsrComponent(CanvasBackground(blah));
